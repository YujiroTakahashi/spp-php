...
class SentencePieceText : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sentencepiece.SentencePieceText) */ {
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static SentencePieceText* default_instance_;
};
// -------------------------------------------------------------------

class NBestSentencePieceText : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:sentencepiece.NBestSentencePieceText) */ {
 public:
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static NBestSentencePieceText* default_instance_;
};
// ===================================================================
